...
public class DriverController {
    ...
    public ResponseEntity<DriverDTO> create(@RequestBody DriverDTO dto) {
        return new ResponseEntity<>(driverService.insert(dto),HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<DriverDTO> update(@PathVariable Long driverID,@RequestBody DriverDTO dto) {
